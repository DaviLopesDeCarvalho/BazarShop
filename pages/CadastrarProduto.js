...
export default function CadastrarProdutoScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <TextInput
        style={styles.input}
        placeholder="Tamanho/Número (ex: GG, 44...)"
      />
      ...
      >
        ...
        <Picker.Item label="Roupas Femininas" value="roupas_femininaas" />
      ...
      <TouchableOpacity style={styles.buttonContainer} onPress={() => alert('Produto salvo!')}>
